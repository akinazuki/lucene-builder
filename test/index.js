...
test('range', t => {
  ...
  t.equal(l.range(114, 514, true, true), '[ 114 TO 514 ]')
  t.equal(l.range(114, 514, true), '[ 114 TO 514 }')
  t.equal(l.range(114, 514, false, true), '{ 114 TO 514 ]')
  t.equal(l.range(114, 514), '{ 114 TO 514 }')
